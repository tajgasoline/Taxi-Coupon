        ...
        <div class="card-body">
         ...
         <div class="text-left">
          <div class="card">
            ...
            <table>
              <tr>
                <td><center><h5>Store</h5></center></td>
                <td><center><h5>Transaction ID</h5></center></td>
                <td></td>
              </tr>
              <tr>
                <td style="width:20%;">
         ...
         <td style="width:20%;">
           <div class="form-group row">
             <button class="btn btn-primary  btn-block waves-effect waves-light" onclick="Search();" id="btnlogin" type="button">Search<i class="fas fa-sign-in-alt ml-1"></i></button>
           </div>
